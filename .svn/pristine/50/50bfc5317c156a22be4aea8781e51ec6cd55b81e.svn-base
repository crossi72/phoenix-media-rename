...
Greatly improve your SEO: rename your media files with the "Media Rename" plugin.
...
NOTE: the plugin will not only loop through your posts' content, but also all your metas and options in order to replace the old links with the new ones. If something goes wrong, it could mess up your database!
Please make sure to backup your database and files before using this plugin.
I am not responsible for any damage caused by its usage!
