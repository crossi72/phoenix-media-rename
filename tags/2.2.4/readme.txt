...
If you would like more features, such as automatic renaming, or a dashboard for renaming files, have a look at the freemium plugin [Media File Renamer](https://wordpress.org/plugins/media-file-renamer)
