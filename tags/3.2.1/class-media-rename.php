...
class Phoenix_Media_Rename {
	 ...
	 * @return void
	 */
	static function do_rename($attachment_id, $new_filename, $retitle = 0, $title_from_post = 0, $name_from_post = 1, $check_post_parent = true ) {
		//Variables
		...
		if ( is_plugin_active( 'archivarix-external-images-importer/archivarix-external-images-importer.php' ) ) {
