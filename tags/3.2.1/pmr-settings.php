...
class PmrSettingsPage
{
	...
	public function page_init()
	{
		...
		add_settings_section(
			...
			__('Debug', 'phoenix-media-rename'), // Title
		...
		add_settings_field(
			'pmr_debug_mode', // ID
			__('Debug mode', 'phoenix-media-rename'), // Title 
	...
	{
		print __('Check to enable debug mode, this will allow full error messages to appear during the rename process:', 'phoenix-media-rename');
	}
